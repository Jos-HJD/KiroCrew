...
_AMBIENT_READ_ALLOWLIST = frozenset(
    {
        # PATH feeds shutil.which(); fingerprinted as path_env (+path_augment
        # for the augmented prefix), and the probe RESULTS are stored + re-run
        # on the cache-hit path.
        ("_resolve_target_command", "os.environ:PATH"),
